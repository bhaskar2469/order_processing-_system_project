...
//     dynamodbTableName := terraform.Output(t, terraformOptions, "G_Bhaskar_OP_123_DynamoDBTable_Name")
 
//     // Add assertions for the DynamoDB Table
//     assert.NotNil(t, dynamodbTableName, "DynamoDB table name should not be nil")
//     assert.Contains(t, dynamodbTableName, "G_Bhaskar_OP_123_DynamoDBTable", "DynamoDB table name should be 'G_Bhaskar_OP_123_DynamoDBTable'")
...
//     assert.Equal(t, "G_Bhaskar_OP_123_LambdaFunction_CRUD", lambdaFunctionName, "Lambda function name should be 'G_Bhaskar_OP_123_LambdaFunction_CRUD'")
 
//     assert.NotNil(t, GetlambdaFunctionName, "Lambda function name should not be nil")
//     assert.Equal(t, "G_Bhaskar_OP_123_LambdaFunction_GET", GetlambdaFunctionName, "Lambda function name should be 'G_Bhaskar_OP_123_LambdaFunction_GET'")
...
//     assert.Equal(t, "G_Bhaskar_OP_123_QueueSQS", sqsQueueName, "Queue name should be 'G_Bhaskar_OP_123_QueueSQS'")
...
//     assert.Equal(t, "G_Bhaskar_OP_123_APIGateway", apiGatewayName, "API Gateway Name should match the expected name")
...
//     assert.Equal(t, "G_Bhaskar_ORDERPROCESSING_123", apiGatewayTags["Name"], "Name tag should be 'G_Bhaskar_ORDERPROCESSING_123'")
